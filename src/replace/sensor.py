...
class Sensor(Commands):
    ...
    @staticmethod
    def start_robot_to_robot_infrared_broadcasting(toy, far_code, near_code, proc=0x012):
        toy._execute(Sensor._encode(toy, 39, proc, [far_code, near_code]))

    @staticmethod
    def start_robot_to_robot_infrared_following(toy, far_code, near_code, proc=0x012):
        toy._execute(Sensor._encode(toy, 40, proc, [far_code, near_code]))

    @staticmethod
    def stop_robot_to_robot_infrared_broadcasting(toy, proc=0x012):
        toy._execute(Sensor._encode(toy, 41, proc))

    @staticmethod
    def send_robot_to_robot_infrared_message(toy, s, s2, s3, s4, s5, proc=0x012):  # Untested / Unknown param names
        toy._execute(Sensor._encode(toy, 42, proc, [s, s2, s3, s4, s5]))

    @staticmethod
    def listen_for_robot_to_robot_infrared_message(toy, s, j, proc=0x012):  # Untested / Unknown param names
    ...
    @staticmethod
    def stop_robot_to_robot_infrared_following(toy, proc=0x012):
        toy._execute(Sensor._encode(toy, 50, proc))

    @staticmethod
    def start_robot_to_robot_infrared_evading(toy, far_code, near_code, proc=0x012):
        toy._execute(Sensor._encode(toy, 51, proc, [far_code, near_code]))

    @staticmethod
    def stop_robot_to_robot_infrared_evading(toy, proc=0x012):
